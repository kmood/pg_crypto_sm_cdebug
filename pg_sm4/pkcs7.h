...
*/
typedef struct {
	uint8_t *    dataWithPadding;        /* result of adding padding to the data */
...
*/
typedef struct {
	uint8_t *    dataWithoutPadding;         /* result of remove padding from data */
...
/* get string size*/
unsigned long StrGetSize(unsigned char * dest);
